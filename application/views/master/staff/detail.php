                ...
                <div class="card-body">
                  <div class="d-flex align-items-center flex-column mb-4">
                    <div class="d-flex align-items-center flex-column">
                      <div class="sw-20 position-relative mb-3">
                        <img src="<?=base_url()?>assets/arsip/master-staff/<?=$data->FOTO?>" class="img-fluid rounded-xl" alt="thumb" />
                      </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row g-0 sh-6">
                          <div class="col-auto">
                            <img src="<?=base_url()?>assets/arsip/master-staff/<?=$data->FOTO?>" class="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                          </div>
                          <div class="col">
